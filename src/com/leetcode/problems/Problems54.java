...
public class Problems54 {
    ...
    public List<Integer> spiralOrder(int[][] matrix) {
        ...
        while(rowStart <= rowEnd && colStart <= colEnd){
            ...
            if(rowStart < rowEnd && colStart < colEnd)  {
                ...
                for(int row = rowEnd; row > rowStart; row--) ans.add(matrix[row][colStart]);
            }
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("spiral order of matrix %s \n", new Problems54().spiralOrder(matrix));
    }
}
